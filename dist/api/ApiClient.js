...
class ApiClient {
  ...
  parseSortSpec(sortSpec) {
    return sortSpec ? sortSpec.map(s => {
  ...
  callApi(method, expectedHttpCode, expectJsonContent, paths, body, params) {
    return new _bluebird.default((resolve, reject) => {
      ...
      if (this.useLtpa) {
        ...
        xhrConfig.headers['Authorization'] = 'Basic ' + (0, _btoa.default)(this.config.auth.key + ':' + this.config.auth.token);
      }
  ...
  callFormDataApi(method, expectedHttpCode, expectJsonContent, paths, body, params) {
    return new _bluebird.default((resolve, reject) => {
      ...
      if (this.useLtpa) {
        ...
        xhrConfig.headers['Authorization'] = 'Basic ' + (0, _btoa.default)(this.apiKey + ':' + this.apiToken);
      }
