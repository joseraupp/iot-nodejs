...
class DeviceConfig extends _BaseConfig.default {
  constructor(identity, auth, options) {
    super(identity, auth, options); //Validate the arguments
  ...
  static parseEnvVars() {
    ...
    let deviceId = process.env.WIOTP_IDENTITY_DEVICEID || null; // Auth

    let authToken = process.env.WIOTP_AUTH_TOKEN || null; // Also support WIOTP_API_TOKEN usage
    ...
    let sharedSubs = process.env.WIOTP_OPTIONS_MQTT_SHAREDSUBSCRIPTION || "false"; // String to int conversions
